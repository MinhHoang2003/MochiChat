...
import vnjp.monstarlablifetime.mochichat.data.repository.UserRepository
import vnjp.monstarlablifetime.mochichat.data.repository.UserRepositoryImp
...
class AuthenticationViewModel : ViewModel() {
    ...
    private var userRepository: UserRepository = UserRepositoryImp(databaseReference, firebaseAuth)
